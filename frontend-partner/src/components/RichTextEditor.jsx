...
export default function RichTextEditor({ value, onChange, placeholder, name, height = 350 }) {
  ...
  }, [name, height]); // Do NOT depend on `value` for initialization to prevent re-inits
