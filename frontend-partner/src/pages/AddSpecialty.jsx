        ...
        <AdminLayout pageTitle="Quản lý Chuyên Khoa">
            <div className="form-page-container">
                <div className="form-page-header">
                    ...
                    <h1 className="form-page-title">Thêm Chuyên Khoa</h1>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="form-page-form">
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-grid">
                                ...
                                <div className="form-group">
                                    ...
                                    <SearchableSelect
                                        name="service_id"
                                        options={[{label: '-- Chưa thuộc dịch vụ nào --', value: ''}, ...services.map(s => ({ label: s.name, value: s.id }))]}
                                        value={formData.service_id}
                                        onChange={(val) => handleChange({ target: { name: 'service_id', value: val } })}
                        ...
                        <div className="form-actions" style={{ marginTop: '2rem' }}>
                            ...
                            <button type="submit" className="btn btn-primary" disabled={submitted}>
                                {submitted ? 'Đang xử lý...' : 'Thêm chuyên khoa'}
                            </button>
                        </div>
                    </form>
                </div>
