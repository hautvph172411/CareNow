...
import { updateClinicPlace, getClinicPlaceById, getClinicPlaceParentOptions } from '../api/clinic_place.api';
...
import { mkContentBlock, normalizeContentBlocksFromApi, serializeContentBlocks } from '../utils/clinicPlacePageContent';
...
export default function EditClinicPlace() {
      ...
      try {
        ...
        if (id) {
          ...
          setFormData({
            ...
            partner_id: d.partner_id != null ? d.partner_id : '',
            place_kind: d.place_kind != null ? Number(d.place_kind) : 3,
            parent_id: d.parent_id != null ? d.parent_id : '',
            rank: d.rank != null ? d.rank : '',
            has_insurance: !!d.has_insurance,
            show_children: !!d.show_children,
          });
          setContentBlocks(normalizeContentBlocksFromApi(d.page_content_blocks, d.info));
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setWards(data.map((dd) => ({ value: String(dd.id), label: dd.name })));
      } catch (e) {
        console.error(e);
      }
    })();
  ...
  }, [formData.partner_id, formData.place_kind, id]);
  ...
  if (bootLoading) {
    return (
      <AdminLayout pageTitle="Chỉnh sửa nơi khám">
    ...
    <AdminLayout pageTitle="Chỉnh sửa nơi khám">
      <div className="form-page-container">
        <div className="form-page-header">
          ...
          <h1 className="form-page-title">Chỉnh sửa nơi khám</h1>
        </div>
          ...
          <form onSubmit={handleSubmit} className="form-page-form">
            ...
            <div className="form-section">
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <SearchableSelect options={wards} value={formData.district_id} onChange={(v) => handleSelectChange('district_id', v)} placeholder="Chọn" disabled={!formData.province_id} />
                </div>
              </div>
            </div>
            ...
            <div className="form-section">
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  <MultipleImageUpload
                    label="Ảnh mô tả (nhiều ảnh, CSV URL)"
