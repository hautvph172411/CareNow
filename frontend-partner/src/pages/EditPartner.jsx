      ...
      try {
        ...
        if (res.success && res.data) {
          setFormData(prev => ({
            ...prev,
            ...res.data,
            status: res.data.status !== undefined && res.data.status !== null ? Number(res.data.status) : 1,
            group: res.data.group !== undefined && res.data.group !== null ? Number(res.data.group) : 1,
            payment_method: res.data.payment_method !== undefined && res.data.payment_method !== null ? Number(res.data.payment_method) : 0,
            booking_fee: res.data.booking_fee !== undefined && res.data.booking_fee !== null ? Number(res.data.booking_fee) : 0,
            rank: res.data.rank !== undefined && res.data.rank !== null ? Number(res.data.rank) : 99,
          }));
        }
      } catch (error) {
