        ...
        <div className="login-grid">
          ...
          <div className="login-left">
            <div className="login-branding">
              {siteLogo ? (
                <img src={siteLogo} alt="Logo" className="sidebar-logo-img" style={{ maxHeight: '48px', objectFit: 'contain' }} />
              ) : (
                <div className="login-logo">BC</div>
              )}
              <h1 className="login-brand-name">{siteName}</h1>
            </div>
            <h2 className="login-title">Quản lý hệ thống</h2>
