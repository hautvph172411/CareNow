    ...
    (async () => {
      try {
        ...
        if (id) {
          ...
          if (d.images) setImagesPreviews(d.images.split(',').filter(Boolean));
        }
      } catch (e) {
        console.error(e);
      } finally {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setDistricts(data.map((dd) => ({ value: String(dd.id), label: dd.name })));
      } catch (e) {
        console.error(e);
      }
    })();
          ...
          <form onSubmit={handleSubmit} className="form-page-form">
            ...
            <div className="form-section">
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  <label>Ảnh mô tả (nhiều ảnh, CSV URL)</label>
